...
@Singleton
class ClientAProfileRepository @Inject constructor() : ProfileRepository {

    private val avatars = listOf(
        ProfileAvatarDto(id = "client-a-default", imageUrl = null),
        ProfileAvatarDto(id = "client-a-cinema", imageUrl = null),
        ProfileAvatarDto(id = "client-a-kids", imageUrl = null),
    )
    ...
    override suspend fun createProfile(profile: CreateProfileModel): AppResult<ProfileModel> {
        ...
        val dto = ProfileDto(
            id = "client-a-profile-created-${nextProfileNumber++}",

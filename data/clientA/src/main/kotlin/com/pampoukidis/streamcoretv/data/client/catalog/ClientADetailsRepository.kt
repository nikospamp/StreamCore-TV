...
@Singleton
class ClientADetailsRepository @Inject constructor(
    private val catalogSource: ClientACatalogSource,
) : DetailsRepository {
    ...
    private fun recommendations(
        selected: ClientAContentDto,
        catalog: List<ClientAContentDto>,
    ): List<ClientAContentDto> {
        ...
        return candidates
            .sortedWith(
                compareByDescending<ClientAContentDto> { content ->

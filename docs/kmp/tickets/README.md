...
**Current gate (2026-09-04): WEB-04D Candidate 2 pending freeze.** WEB-03 remains accepted at
...
closed. These focused results do not replace Candidate 1's failed matrix. Candidate 2 is not yet frozen; its production/Binaryen artifact,
artifact validator, complete 186-test six-project matrix, Android/root gate, inspected visuals, manual current Safari/macOS, and final authorized
live journey remain required before WEB-04 acceptance. The target architecture remains backend-agnostic.
